...
namespace Methods_Exercise_01_Answers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The answer to your question is {result}.");
            AddSpaces();
            ...
            while (userInput.ToLower() != "no")
            {
                ...
                AddSpaces();
                Console.WriteLine("Would you like to continue?" + " " + "(Enter 'yes' to continue and enter 'no' to exit.)");
        ...
        public static double Exponentiate()
        {
            ...
            var  firstNum = double.TryParse(Console.ReadLine(), out double num1);
            Console.WriteLine("Give me a second number to power to: ");
            var secondNum = double.TryParse(Console.ReadLine(), out double num2);
        ...
        {
            Console.WriteLine("Hi, give me a number to see if it is a prime number.");
